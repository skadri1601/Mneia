...
const SUBPROCESSORS: LegalBlock = {
  ...
  rows: [
    ['Vercel Inc.', 'Hosts this website and the hosted API', 'United States'],
    ...
    ['Clerk Inc.', 'Authentication and organisation management', 'United States'],
      ...
      blocks: [
        {
          ...
          paragraphs: [
            ...
            '**Your content is your confidential information.** This obligation survives the end of the agreement. It does not apply to information that is public through no fault of the recipient, was already known, or is independently developed — and disclosure compelled by law is permitted, with notice to the other party where the law allows it.',
          ],
        },
      ],
    },
