...
<!-- mneia:begin sha=e1ea29e3603dd33f -->
Generated by `mneia init`. Everything between the mneia markers is rewritten on every run;
edit outside them.

## Project memory

This repository is bound to the Mneia project `workspace-874090eb-c7bc-49ef-b653-93e24148a92c/mneia` on https://app.mneia.dev.

Your agent loads this memory on its own at session start — Claude Code, Codex and Cursor each have a hook installed
...
28 constraints were imported from AGENTS.md, CLAUDE.md.
<!-- mneia:end -->
