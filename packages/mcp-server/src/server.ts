...
export const SERVER_INSTRUCTIONS = [
  ...
  'Items that need a human to confirm come back as a pending queue — surface them to the user rather than treating them as written. Call mneia_review_queue to read everything still waiting on a person; it is read-only, and draining it is theirs to do with `mneia review --drain`.',
